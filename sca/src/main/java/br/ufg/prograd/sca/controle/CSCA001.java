...
/**
 * Faz a pesquisa dos horários no sistem SiDS da UFG e apresnta a tabela de horários para um centro de aulas
 * específico.
 *
...
public class CSCA001 extends GenericForwardComposer<Component> {
  ...
  private void tratarConteudo(final HttpURLConnection con) throws Exception {
    if (con != null) {
      try {
        ...
        throw new Exception("Problemas de conex�o com o SiDS!");
      }
    }
  }
  ...
  public int prepararTabela(final int inicio) {
    ...
    /** pegando os r�tulos das colunas das salas a serem apresentadas no momento */
    ...
    for (int contador1 = 0; contador1 < this.resultadoConsulta.size(); contador1++) {
      ...
      /** selecionando somente os hor�rios depois da hora atual */
